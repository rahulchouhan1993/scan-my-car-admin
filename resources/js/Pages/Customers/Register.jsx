...
const Register = () => {
  return (
    <>
      <div className="relative min-h-screen flex items-center justify-center py-[180px]">
        ...
        <div className="container relative z-10 flex flex-col lg:flex-row w-full max-w-6xl shadow-lg rounded-lg overflow-hidden">
          ...
          {/* Left Side - Form */}
          <div className="w-full lg:w-1/2 bg-[#192735] p-[25px]">
            <div className='border-b-[1px] border-b-[#ffffff29] pb-[30px] mb-[40px]'>
              <h1 className="ppfont text-2xl md:text-3xl text-[#ffffff87] mb-[10px]">Welcome to certifycar</h1>
              <p className="creatodisplayM text-[20px] text-[#fff]">
            ...
            <form className="space-y-5">
              ...
              <button type="submit" className="creatodisplayB flex-inline cursor-pointer redbt w-[247px] bg-[#F61221] text-[20px] text-white rounded-full py-[17px] hover:opacity-90 transition">Submit</button>
            </form>
          </div>
