            ...
            <table role="presentation" class="email-container" cellspacing="0" cellpadding="0" border="0" width="800">
              ...
              <tr>
                <td align="left" style="padding: 0 50px;">
                  <h2 style="font-size: 26px; line-height: 34px; font-weight: bold; color: #333333;">
                    Dear {{ $inspectionsDetail->name }},</h2>
                </td>
              </tr>
              ...
              <tr>
                <td align="left" style="padding: 0 50px; font-size: 16px; line-height: 24px; color: #333333;">
                  <p>Thank you for booking an inspection with us.</p>
                    <p><strong>Your assigned inspector is:</strong></p>
                    <p><strong>Name:</strong> {{ $userDetail->name }}</p>
                    <p><strong>Contact Number:</strong> {{ $userDetail->phone_no }}</p>
                    <p>Our dedicated expert will meet you at the scheduled time and location.</p>
                    <p>Thank you for choosing Certifycars.ae</p>
                </td>
              </tr>
