            ...
            <table role="presentation" class="email-container" cellspacing="0" cellpadding="0" border="0" width="800">
              ...
              <tr>
                <td align="left" style="padding: 40px 50px 20px 50px;">
                  <img src="{{ env('APP_URL') }}/images/logo-black.png" alt="Logo" width="130" height="130" style="display: block;">
                </td>
              </tr>
              ...
              <tr>
                <td align="left" style="padding: 0 50px;">
                  <h2 style="font-size: 26px; line-height: 34px; font-weight: bold; color: #333333;">
                    We’ve completed the inspection of your vehicle . Please find the detailed inspection report attached for your review.</h2>
                </td>
              </tr>
              ...
              <tr>
                <td align="left" style="padding: 0 50px; font-size: 16px; line-height: 24px; color: #333333;">
                  We have also attached a copy of the inspection report for your records. If you have any questions or need further assistance, please do not hesitate to contact us at {{ env('MAIL_USERNAME') }}.
                </td>
              </tr>
